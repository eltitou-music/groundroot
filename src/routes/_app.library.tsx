  ...
  return (
    <div className="relative flex min-h-[calc(100vh-4rem)] flex-col items-center px-6 py-20">
      <div className="mx-auto w-full max-w-3xl">
        ...
        >
          every sound you've collected, in one place — taggable, searchable, ready to drop into a set.
        </motion.p>
        ...
        >
          ...
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
            Connect Spotify, upload local files, or pull from cloud drives. Sounds are auto-analyzed for key, BPM, and energy so you can find them by feeling, not just by name.
          </p>
        </motion.div>
      </div>
    </div>
